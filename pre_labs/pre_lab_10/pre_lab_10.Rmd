...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer: zipcodes, zipna,es, shape length, shape area, geometry**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer: it has places like city and town names along with the given zipcodes + maybe coordinates? I'm not quite sure what the geometry column means.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: its a map of the different zipcodes in MD.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: to enable caching of data, set 'options(tigris_use_cache = TRUE)` in your R script or .Rprofile.?**
...
**Task** Run the following code. Describe the output in the space below. **Answer: more county names and state numbers? very mixed amount of data..."**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Same as above but this time MD counties and more specific**
...
**Task** Run the following code. Describe the output in the space below. **Answer: it's just MD counties not specific zip code lines**
...
**Task** Run the following code. Describe the output in the space below. **Answer: every zipcode in MD**
...
**Task** Run the following code. Describe the output in the space below. **Answer: March 2023 foreclosures per zipcode in MD**
...
**Task** Run the following code. Describe the output in the space below. **Answer: zipcodes and towns in MD with foreclosure notices**
...
**Task** Run the following code. Describe the output in the space below. **Answer: a map of MD zipcodes with foreclosure notices and a theme of blues the darker, the less, the lighter the more in March 2023.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: dates, type of notices, county its in, and how many notices**
...
**Task** Run the following code. Describe the output in the space below. **Answer: notices per county in March 2023 and the type so just foreclosures**
...
**Task** Run the following code. Describe the output in the space below. **Answer: population of Md counties with the geometry column**
...
**Task** Run the following code. Describe the output in the space below. **Answer: shows the same as above but more summarizes with the population total like above but this time more organized**
...
**Task** Run the following code. Describe the output in the space below. **Answer: same as above but with an added column of rate per population**
...
**Task** Run the following code. Describe the output in the space below. **Answer: same as above but with labels to each county**
...
**Task** Run the following code. Describe the output in the space below. **Answer: no labels but with different color and a magma scale**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: different key its out of 2.0 1.0 and 0.74 and tthe colors are a bit different. Less foreclosures are in more rural areas, more foreclosures are in more urban areas.**
