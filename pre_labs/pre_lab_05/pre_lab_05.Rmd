...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer: The data is cofnusing, it doesn't tell us what the numbers are.**
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer: IT's too much information given**
...
**Task** Run the codeblock below. What else do we need to do? **Answer: Make the data for easy to filter or become more consise.**
