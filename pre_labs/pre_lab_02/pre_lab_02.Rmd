...
**Answer: It makes the search even more specific, down to just a specific id and six rows rather than 1-9.**
...
**Answer: It gives the possibility that it could happen but it isn't guranteed so there will be more answers available rather than the YES narrows down the outcome more.**
...
**Answer: The year is changed to be in front of the month and date rather in than in normal month, day, year format.**
...
**Answer: It is order time order rather than random.**
...
**Answer: Creates new columns called for total votes and total votes.**
...
**Answer: it arranges the total votes.**
...
**Answer: More useful because it gives many different details and columns than before.**
...
**Answer: str_to_lower() converts strings to lowercase and str_to_title() converts strings to title case (first letter of each word uppercase**
...
**Answer: I think it separates the columns by states?**
...
**Answer: Is it the average maryland expenses per state? I'm not sure.**
...
1.  What major has the most seats and most sections?

2.  What term had the least amount of courses?

3.  What department has the least amount of instructors?
