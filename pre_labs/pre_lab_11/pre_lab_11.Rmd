...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer: it creates a list of values that contain the word Dog or cat.**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer: tells you which words are the most common, the first in this dataset is "is"**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer: it shows the most common words used in the dataset and how many are used. it is interesting to see just how many "the" there are.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer: more interesting because its more specific and includes more interesting words than just in and the. patient is used in 1.3% of data in this set.**
...
**Task** Run the following code and describe the results. **Answer: disciplinary and health are the most common words.**
...
**Task** Run the following code and describe the results. **Answer: health occ and md code are the most common.**
...
**Task** Run the following code and describe the results. **Answer: it is quite similar to 2021**
...
**Task** Run the following code and describe the results. **Answer: summary suspension and individual 4 have gotten higher up**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: maybe counter-intuitive**
