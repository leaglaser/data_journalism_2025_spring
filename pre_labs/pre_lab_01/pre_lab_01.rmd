...
**Answer: different UMD classes for each semester per year since 2017 plus how many classes were offered during each year**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: The year became 2024 and how many classes are offered per year all semesters included**
...
**Answer: how many classes per term per department summarized together and how many classes within those**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: total seats were calculated and it increased per year until 2024**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer: median, mean and total seats per course were summarized. they have a similar median**
...
**Answer: maximum amount of seats calculated and minimum added to the data. it is sorted by year**
...
1.  Why is there nearly 42,000 total seats for agricultural and resource economics department?

2.  What is the likelihood of mean seats increasing in the ACES-Cybersecurity department?

3. Why do some minimum seats have 10 or 25 seats?
