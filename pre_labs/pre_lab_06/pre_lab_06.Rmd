...
**Task** Load the five CSV files. Do they have the same column structure? **Answer: Yes, they all have the same column structure.**
...
**Task** Run the following code to join Maryland population data and the 2020 voter registration data together using the common column county as the key. How many rows are there now? How many *should* there be? **Answer: 24 rows, there should be 24.**
...
**Task** Create a new dataframe with population and voter data joined together. What does the output message below say about the join? **Answer: You added multiple columns to the right of the county population that includes the year and type of voter they are.**
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Answer: Prince George's County and Baltimore City**
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer: Howard County and Montgomery County.**
